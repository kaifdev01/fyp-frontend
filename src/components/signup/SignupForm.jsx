  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="relative">
          <input
            ...
            onChange={handleInputChange}
            className={`w-full px-4 py-3 pr-12 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all ${
        ...
        <div className="flex items-start space-x-3 pt-2">
          ...
          <p className="text-sm text-gray-600 leading-tight">
            ...
            <Link href="/terms" className="text-blue-600 hover:underline font-medium">Terms of Service</Link> and{" "}
      ...
      <p className="text-center text-sm text-gray-600 mt-6">
        ...
        <Link href="/login" className="text-blue-600 hover:underline font-bold">Log In</Link>
      </p>
    </motion.div>
  );
}
